...
SELECT U.USER_ID, U.FIRST_NAME, U.LAST_NAME, U.YEAR_OF_BIRTH, U.MONTH_OF_BIRTH, U.DAY_OF_BIRTH, U.GENDER, CC.CITY_NAME, CC.STATE_NAME, CC.COUNTRY_NAME, HC.CITY_NAME, HC.STATE_NAME, HC.COUNTRY_NAME, P.INSTITUTION, E.PROGRAM_YEAR, P.CONCENTRATION, P.DEGREE
FROM USERS U
LEFT JOIN USER_HOMETOWN_CITY UHC ON UHC.USER_ID = U.USER_ID
LEFT JOIN USER_CURRENT_CITY UCC ON UCC.USER_ID = U.USER_ID
LEFT JOIN CITIES HC ON HC.CITY_ID = UHC.HOMETOWN_CITY_ID
LEFT JOIN CITIES CC ON CC.CITY_ID = UCC.CURRENT_CITY_ID
